#!/usr/bin/python3
"""Contains unit tests for models/city.py.

Unittest classes:
    TestCity_initialization
    TestCity_save
    TestCity_to_dict
"""
import os
...
class TestCity_initialization(unittest.TestCase):
    """Unittests for testing city class's initialization."""

    def test_0_args_instantiates(self):
        self.assertEqual(City, type(City()))

    def test_new_instance_stored_in_storage(self):
        self.assertIn(City(), models.storage.all().values())

    def test_id_if_public_str(self):
        self.assertEqual(str, type(City().id))

    def test_created_at_if_public_datetime(self):
        self.assertEqual(datetime, type(City().created_at))

    def test_updated_at_if_public_datetime(self):
        self.assertEqual(datetime, type(City().updated_at))

    def test_state_id_if_public_class_attribute(self):
        cy = City()
        self.assertEqual(str, type(City.state_id))
        self.assertIn("state_id", dir(cy))
        self.assertNotIn("state_id", cy.__dict__)

    def test_name_if_public_class_attribute(self):
        cy = City()
    ...
    def test_2_cities_unique_ids(self):
        cyt1 = City()
        cyt2 = City()
        self.assertNotEqual(cyt1.id, cyt2.id)
...
class TestCity_save(unittest.TestCase):
    """Unittests for testing City class's save method."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests for testing City class's to_dict method."""

    def test_to_dict_type(self):
        self.assertTrue(dict, type(City().to_dict()))

    def test_to_dict_if_has_correct_keys(self):
        cy = City()
    ...
    def test_to_dict_if_correctly_added_attributes(self):
        cy = City()
        cy.middle_name = "Mercy"
        cy.my_number = 98
        self.assertEqual("Mercy", cy.middle_name)
        self.assertIn("my_number", cy.to_dict())

    def test_to_dict_datetime_attributes_if_strs(self):
        cy = City()
        cy_dict = cy.to_dict()
