...
class TestFileStorage_initialization(unittest.TestCase):
    """Unittests for testing initialization of the FileStorage class."""

    def test_FileStorage_initialization_0_args(self):
        self.assertEqual(type(FileStorage()), FileStorage)

    def test_FileStorage_initialization_with_arg(self):
        with self.assertRaises(TypeError):
            FileStorage(None)

    def test_FileStorage_file_path_if_private_str(self):
        self.assertEqual(str, type(FileStorage._FileStorage__file_path))

    def testFileStorage_objects_if_private_dict(self):
...
class TestFileStorage_methods(unittest.TestCase):
    """Unittests for testing FileStorage class's methods."""
