...
class TestUser_initialization(unittest.TestCase):
    """Unittests for testing initialization of the User class."""
    ...
    def test_id_if_public_str_type(self):
    ...
    def test_email_if_public_str(self):
        self.assertEqual(str, type(User.email))

    def test_password_if_public_str_type(self):
        self.assertEqual(str, type(User.password))

    def test_1st_name_is_public_str(self):
    ...
    def test_instantiation_with_kwargs(self):
        t = datetime.today()
        t_iso = t.isoformat()
        us = User(id="345", created_at=t_iso, updated_at=t_iso)
        self.assertEqual(us.id, "345")
        self.assertEqual(us.created_at, t)
        self.assertEqual(us.updated_at, t)
...
class TestUser_save(unittest.TestCase):
    """Unittests for save method of theuser class"""
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_datetime_attribs_are_strs(self):
        us = User()
        us_dict = us.to_dict()
    ...
    def test_to_dict_contrasts_with_dunder_dict(self):
        us = User()
